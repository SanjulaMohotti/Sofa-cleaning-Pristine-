        ...
        <div className="grid lg:grid-cols-4 md:grid-cols-2 gap-8">
          ...
          <div className="col-span-1">
            <div className="flex items-center mb-6">
              ...
              <span className="ml-3 text-xl font-bold">CleanSofa Pro</span>
            </div>
            <p className="text-gray-400 mb-6 leading-relaxed">
              Professional sofa cleaning services that restore your furniture to its original beauty. 
        ...
        <div className="border-t border-gray-800 pt-8 mt-12">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="text-gray-400 text-sm mb-4 md:mb-0">
              © {currentYear} CleanSofa Pro. All rights reserved.
            </div>
          ...
          <div className="flex flex-wrap justify-center gap-4 mt-8 pt-8 border-t border-gray-800">
            ...
            <div className="flex items-center space-x-2">
              ...
              <span className="text-xs text-gray-400">Certified Professionals</span>
            </div>
            <div className="flex items-center space-x-2">
              <div className="w-8 h-8 bg-green-600 rounded-full flex items-center justify-center">
